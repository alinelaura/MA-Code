...
ggsave("/Users/alinelaurametzler/Documents/Universität/Master/Master Thesis/MA-Code/Output/0_plot_votertypes_share.png")
...
ggsave("/Users/alinelaurametzler/Documents/Universität/Master/Master Thesis/MA-Code/Output/0_plot_votertypesdet_share.png")
```
...
ggsave("/Users/alinelaurametzler/Documents/Universität/Master/Master Thesis/MA-Code/Output/1_income_dist_votertypes.png")
...
ggsave("/Users/alinelaurametzler/Documents/Universität/Master/Master Thesis/MA-Code/Output/1_wealth_dist_votertypes.png")
...
ggsave("/Users/alinelaurametzler/Documents/Universität/Master/Master Thesis/MA-Code/Output/1_hhincome_dist_votertypes.png")
```
...
# save Plot 
ggsave("/Users/alinelaurametzler/Documents/Universität/Master/Master Thesis/MA-Code/Output/2_plot_predprob.png",
...
scatter_income <- data_mlogit %>% 
  ...
  theme_masterthesis() 
scatter_income
ggsave("/Users/alinelaurametzler/Documents/Universität/Master/Master Thesis/MA-Code/Output/4_scatter_income.png")
...
ggsave("/Users/alinelaurametzler/Documents/Universität/Master/Master Thesis/MA-Code/Output/4_scatter_hhaequEinkommen.png")
```
...
plot_did_incometo0
ggsave("/Users/alinelaurametzler/Documents/Universität/Master/Master Thesis/MA-Code/Output/4_plot_did_incometo0.png")
...
plot_did_wealthto0
ggsave("/Users/alinelaurametzler/Documents/Universität/Master/Master Thesis/MA-Code/Output/4_plot_did_wealthto0.png")
```
...
data_households <- data %>% 
  ...
  mutate(older_pers_vote = as.factor(older_pers_vote),
         older_pers_vote = fct_relevel(older_pers_vote, c("Keine Eltern partizipieren", 
                                                          "Teils der Eltern partizipieren", 
                                                          "Alle Eltern partizipieren"))) %>% 
  select(-sum_older_pers_vote) %>% 
  # all measures in 1000.- Fr.
  mutate(steuerb_einkommen_imputed1000k = steuerb_einkommen_imputed/1000,
         massgebendesEinkommen_imputed1000k = massgebendesEinkommen_imputed/1000,
         reinvermoegen_imputed1000k = reinvermoegen_imputed/1000,
         hhaequEinkommen1000k = hhaequEinkommen/1000,
         hhaequVermoegen1000k = hhaequVermoegen/1000,
         income_older1000k = income_older/1000,
         wealth_older1000k = wealth_older/1000)
  
# only keep younger gen and take one random vote date per individual
data_households_young <- data_households %>% 
  filter(young_pers == 1) %>% 
  mutate(householdID = as.character(householdID_sw_imp)) %>% 
  ungroup() 
  # group_by(id_ek) %>%
  # # take one random vote per Individual
  # # TODO: Oder Individuum Effekt und Familien Effekt wie bei Goldberg & Sciarini 2021
  # sample_n(1)
...
# Regression analysis ->Multilevel analysis
library(lme4)

# empty model for icc
model_young_empty <- glmer(beteiligt_num ~  (1 | householdID) , 
                           family = binomial(link = "logit"),
                           data = data_households_young)

# model 1: only level 1
model_young_ind <- glmer(beteiligt_num ~ alter_v + sex_c + konfession_c + residenz10 + zugezogen +
                           steuerb_einkommen_imputed1000k + reinvermoegen_imputed1000k + (1 | householdID), 
                         family = binomial(link = "logit"),
                         data = data_households_young)


# model 2: only level 2
model_young_hh <- glmer(beteiligt_num ~ income_older1000k + wealth_older1000k + older_pers_vote + (1 | householdID), 
                        family = binomial(link = "logit"),
                        data = data_households_young)


# model 3: level 1 & 2
model_young_ind_hh <- glmer(beteiligt_num ~ alter_v + sex_c + konfession_c + residenz10 + zugezogen +
                              steuerb_einkommen_imputed1000k + reinvermoegen_imputed1000k + 
                              income_older1000k + wealth_older1000k + older_pers_vote + (1 | householdID), 
                           family = binomial(link = "logit"),
                           data = data_households_young)


# All models together
stargazer(model_young_empty, model_young_ind, model_young_hh, model_young_ind_hh, type = "text")
...
Multilevel Model with binary dependent variable and cross-level interaction effect
https://rpubs.com/corey_sparks/70812
...
```{r message=FALSE, warning=FALSE}
 ...
 # Load the the three data sets from MA_adminDataPreparation.R
load("/Users/alinelaurametzler/Documents/Universität/Master/Master Thesis/MA-Code/Data/PreparedData/data_votes.RData")
...
turnout_lowimp <- votes_data_short %>% 
